...
describe('OlympianEvent model', () => {
  beforeAll(async () => {
    ...
    await Olympian.create(Olympian.create({name: "Test!", team_id: teamId, sport_id: sportId, age: 25, height: 150, weight: 140, sex: "M"}))
  ...
  test("All", () => {
    return OlympianEvent.all()
      .then(olympian_events => {
        ...
        expect(olympianEvent.eventId).toBe(eventId)
      })
  })
